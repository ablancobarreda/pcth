...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2" >
                <div class="col-sm-6">
				<h1 class="m-0 text-dark"><spam><i class="fas fa-list-ol"></i></spam> Listado de los cursos de entrenamientos</h1>
                </div>
                <!-- /.col -->
				<div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item "><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item active">Listado de los cursos de entrenamientos</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
		...
		<div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
							...
							<form action="<?php echo base_url('index.php/controller/expCursoEntPDF')?>" method="POST" >
							<div class='col-4'>
							...
							<button style='margin-left: 20px;' type='submit' class='btn btn-secondary' title='Exportar'><i class='fas fa-file-pdf'></i> Exportar PDF</button>
								...
								<table id="ltscursoentpdf" class="table table-bordered table-striped" width="100%">
                                        <thead>
                                            <tr >
                                                <th>Denominación</th>
                                        ...
                                        <tbody>
										<?php if($cursoent->result() == null) {
											echo "<tr><td colspan='6'><center>No existen cursos de entrenamientos...</center></td></tr>";
										}?>
										<?php foreach ($cursoent->result() as $t) { ?>
												<tr id="tabla_responsable">
												<td><?php echo $t->denimicacion; ?></td>
												<td><?php echo $t->centroEstudio; ?></td>
												<td><?php echo $t->fecha; ?></td>
												<td><?php echo $t->cantHoras; ?></td>
												<td><?php echo $t->califiacion; ?></td>
												<td>
