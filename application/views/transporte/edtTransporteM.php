...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><spam><i class="fas fa-edit"></i></spam> Editar medio de transporte:</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Editar medio de transporte</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
				<div class="card-header text-white" style=" background: linear-gradient(to right, #1e88e5, #66bb6a);">
					<spam><i class="fas fa-edit"></i></spam> <b>Editar datos del medio de transporte</b>
				</div>
              <!-- /.card-header -->
              <!-- form start -->
              <form onsubmit="return validar()" action="<?php echo base_url('index.php/controller/edtTransporteM')?>" method="POST" >
			  <?php  foreach ($transporte->result() as $p) {  ?>
			 	 <div class="card-body">
				  
				  <input type="hidden" class="form-control" value="<?php echo $p->idmedioTransporte ; ?>" name="idm" id="idm" > 
				  ...
				  <div class="row">
					...
					<div class="form-group col-md-4">
						<label for="organo"><label style="color: red;">*&nbsp;</label>Tipo de asignación:</label>
						<select onchange="showInp()" class="form-control" id="tipo" name="tipo"  >      
							<option disabled selected value="0">--Seleccione el tipo--</option>
							<option value="Propio" <?php if($p->tipoAsignacion == "Propio") echo 'selected="selected"'?>>Propio</option>
							<option value="Asignado" <?php if($p->tipoAsignacion == "Asignado") echo 'selected="selected"'?>>Asignado</option>
						</select>  
						<p id="msgTipo" style="color: red;"></p>
					</div>
					<div class="col-1 "></div>
				
				  <div class="col-1" <?php if($p->tipoAsignacion != "Propio") echo 'style="display: none"' ;?> id="col1estado"></div>
					<div class="form-group col-md-4"  <?php if($p->tipoAsignacion != "Propio") echo 'style="display: none"' ;?> id="col4estado">
				  		<label for="problematica"><label style="color: red;">*&nbsp;</label>Estado:</label><input type="text" value="<?php echo $p->estado ; ?>"   pattern="[a-zA-Z\sñÑáéíóúÁÉÍÚÓ]+" oninput="checkEstado(this);"  class="form-control" name="denominiacion" id="denominiacion" placeholder="Entre el estado del medio de transporte">  
						<p id="msgDenominiacion" style="color: red;"></p>
					</div>
					<div class="col-1"  <?php if($p->tipoAsignacion != "Propio") echo 'style="display: none"' ;?> id="col2estado"></div>
