...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><spam><i class="fas fa-edit"></i></spam> Editar tesis:</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Editar tesis</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
				<div class="card-header text-white" style=" background: linear-gradient(to right, #1e88e5, #66bb6a);">
					<spam><i class="fas fa-edit"></i></spam> <b>Editar datos de la tesis</b>
				</div>
              <!-- /.card-header -->
              <!-- form start -->
              <form onsubmit="return validar()" action="<?php echo base_url('index.php/controller/edtTesisM')?>" method="POST" >
			  <?php  foreach ($tesis->result() as $t) {  ?>
			 	 <div class="card-body">
				  
				  <input type="hidden" class="form-control" value="<?php echo $t->idtesis ; ?>" name="idt" id="idt" > 
				  ...
				  <div class="col-1"></div>
					<div class="form-group col-md-4">
				  		<label for="problematica"><label style="color: red;">*&nbsp;</label>Centro estudio:</label><input type="text" value="<?php echo $t->centroEstudio; ?>"  required  pattern="[a-zA-Z\sñÑáéíóúÁÉÍÚÓ]+"  oninput="checkCentroEstudio(this);" class="form-control" name="centroestudio" id="centroestudio" placeholder="Entre el centro estudio">  
					...
					<div class="col-1"></div>
					<div class="form-group col-md-4">
				  		<label for="cargo"><label style="color: red;">*&nbsp;</label>Título:</label><input type="text" value="<?php echo $t->titulo; ?>" required  pattern="[a-zA-Z\sñÑáéíóúÁÉÍÚÓ]+"  oninput="checkTitulo(this);" class="form-control" name="titulo" id="titulo" placeholder="Entre el titulo">  
					...
					<div class="form-group col-md-4">
						...
						<select onchange="cambioTAutor()" class="form-control" id="tipoautor" name="tipoautor"  >      
							<option disabled  value="0">--Seleccione el tipo de autor--</option>
							<option value="Cadete propio" <?php if($t->tipoAutor == "Cadete propio") echo 'selected="selected"'?>>Cadete propio</option>
							<option value="Cadete insertado" <?php if($t->tipoAutor == "Cadete insertado") echo 'selected="selected"'?>>Cadete insertado</option>
							<option value="Curso por encuento" <?php if($t->tipoAutor == "Curso por encuento") echo 'selected="selected"'?>>Curso por encuento</option>
						</select>  
					...
					<div class="col-1"></div>
					<div class="form-group col-md-4">
				  		<label for="fechaDefensa"><label style="color: red;">*&nbsp;</label>Fecha defensa:</label><input type="date" value="<?php echo $t->fechaDefensa; ?>" required  class="form-control" name="fechaDefensa" id="fechaDefensa" >  
					...
					<div class="form-group col-md-4">
						...
						<select onchange="cambioClasif()" class="form-control" id="clasificacion" name="clasificacion"  >      
							...
							<option value="Abierta" <?php if($t->clasificacion == "Abierta") echo 'selected="selected"'?>>Abierta</option>
							<option value="Secreta" <?php if($t->clasificacion == "Secreta") echo 'selected="selected"'?>>Secreta</option>
						</select>  
					...
					<div class="col-1"></div>
					<div class="form-group col-md-4">
				  		<label for="cargo"><label style="color: red;">*&nbsp;</label>Centro de referencia:</label><input type="text" value="<?php echo $t->centroReferencia; ?>" required  pattern="[a-zA-Z\sñÑáéíóúÁÉÍÚÓ]+"  oninput="checkCReferencia(this);" class="form-control" name="centroReferencia" id="centroReferencia" placeholder="Entre el centro de referencia">  
