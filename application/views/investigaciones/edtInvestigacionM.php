...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><spam><i class="fas fa-edit"></i></spam> Editar investigación:</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Editar investigación</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
				<div class="card-header text-white" style=" background: linear-gradient(to right, #1e88e5, #66bb6a);">
					<spam><i class="fas fa-edit"></i></spam> <b>Editar datos de la investigación</b>
				</div>
              <!-- /.card-header -->
              <!-- form start -->
              <form onsubmit="return validar()" action="<?php echo base_url('index.php/controller/edtInvestigacionM')?>" method="POST" >
			  <?php  foreach ($investig->result() as $p) {  ?>
			 	 <div class="card-body">
				  
				  <input type="hidden" class="form-control" value="<?php echo $p->idinvestigacionesRealizadas ; ?>" name="idp" id="idp" > 
				  ...
				  <div class="col-1"></div>
					<div class="form-group col-md-4">
				  		<label for="problematica"><label style="color: red;">*&nbsp;</label>Nombre:</label><input type="text" value="<?php echo $p->nombreInvestigacion ; ?>"  required  pattern="[a-zA-Z\sñÑáéíóúÁÉÍÚÓ]+"  oninput="checkTrabajo(this);" class="form-control" name="trabajo" id="trabajo" placeholder="Entre el nombre del trabajo">  
					...
					<div class="form-group col-md-4">
				  		...
				  		<?php $anno = date('Y'); ?>
						  <option disabled value="0">--Seleccione el año--</option>
						  <?php for($i=0; $i<100; $i++){ ?>
							<option value="<?php echo $anno - $i; ?>" <?php if($p->anno ==  ($anno - $i) ) echo 'selected="selected"'?>><?php echo $anno - $i; ?></option>
						<?php } ?>
                  		</select>
