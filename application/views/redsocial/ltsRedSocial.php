...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2" >
                <div class="col-sm-6">
				<h1 class="m-0 text-dark"><spam><i class="fas fa-list-ol"></i></spam> Listado de las redes sociales</h1>
                </div>
                <!-- /.col -->
				<div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item "><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item active">Listado de las redes sociales</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
		...
		<div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
							...
							<form action="<?php echo base_url('index.php/controller/expRedSocialPDF')?>" method="POST" >
							<div class='col-4'>
							...
							<button style='margin-left: 20px;' type='submit' class='btn btn-secondary' title='Exportar'><i class='fas fa-file-pdf'></i> Exportar PDF</button>
								...
								<table id="ltsproyectospdf" class="table table-bordered table-striped" width="100%">
                                        ...
                                        <tbody>
										<?php if($redsocial->result() == null) {
											echo "<tr><td colspan='3'><center>No existen redes sociales...</center></td></tr>";
										}?>
										<?php foreach ($redsocial->result() as $t) { ?>
												<tr id="tabla_responsable">
												<td><?php echo $t->nombre; ?></td>
												<td><?php echo $t->cuenta; ?></td>
												<td>
