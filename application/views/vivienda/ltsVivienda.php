...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2" >
                <div class="col-sm-6">
				<h1 class="m-0 text-dark"><spam><i class="fas fa-list-ol"></i></spam> Listado de las viviendas</h1>
                </div>
                <!-- /.col -->
				<div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item "><a href="#">Inicio</a></li>
                        <li class="breadcrumb-item active">Listado de las viviendas</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
							...
							<button style='margin-left: 20px;' type='submit' class='btn btn-secondary' title='Exportar'><i class='fas fa-file-pdf'></i> Exportar PDF</button>
								...
								<table id="ltsproyectospdf" class="table table-bordered table-striped" width="100%">
										...
										<?php if($vivienda->result() == null) {
											echo "<tr><td colspan='3'><center>No existen viviendas...</center></td></tr>";
										}?>
										<?php foreach ($vivienda->result() as $t) { ?>
												<tr id="tabla_responsable">
												<td><?php echo $t->tipoVivienda; ?></td>
