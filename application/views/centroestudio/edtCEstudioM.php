...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><spam><i class="fas fa-edit"></i></spam> Editar centro de estudio:</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Editar centro de estudio</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
				<div class="card-header text-white" style=" background: linear-gradient(to right, #1e88e5, #66bb6a);">
					<spam><i class="fas fa-edit"></i></spam> <b>Editar datos del centro de estudio</b>
				</div>
              <!-- /.card-header -->
              <!-- form start -->
              <form onsubmit="return validar()" action="<?php echo base_url('index.php/controller/edtCEstudioM')?>" method="POST" >
			  <?php  foreach ($cestudio->result() as $i) {  ?>
				  ...
				  <div class="row">
					...
					<div class="form-group col-md-4">
				  		<label for="cargo"><label style="color: red;">*&nbsp;</label>Nombre:</label><input type="text" value="<?php echo $i->nombre ; ?>" required  pattern="[a-zA-Z\sñÑáéíóúÁÉÍÚÓ]+"  oninput="checkNombre(this);" class="form-control" name="nombre" id="nombre" placeholder="Entre el nombre del centro">  
					...
					<div class="form-group col-md-4">
						...
						<select onchange="cambioTipo()" class="form-control" id="tipo" name="tipo"  >      
							<option disabled   value="0">--Seleccione la enseñanza--</option>
							<option value="Enseñanza primaria" <?php if($i->tipo == "Enseñanza primaria") echo 'selected="selected"'?>>Enseñanza primaria</option>
							<option value="Enseñanza secundaria" <?php if($i->tipo == "Enseñanza secundaria") echo 'selected="selected"'?>>Enseñanza secundaria</option>
							<option value="Enseñanza media-superior" <?php if($i->tipo == "Enseñanza media-superior") echo 'selected="selected"'?>>Enseñanza media-superior</option>
							<option value="Enseñanza superior" <?php if($i->tipo == "Enseñanza superior") echo 'selected="selected"'?> >Enseñanza superior</option>
							<option value="Enseñanza técnica" <?php if($i->tipo == "Enseñanza técnica") echo 'selected="selected"'?> >Enseñanza técnica</option>
						</select>  
