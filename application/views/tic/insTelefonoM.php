...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><spam><i class="fas fa-plus"></i></spam> Insertar teléfono:</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Insertar teléfono</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
				<div class="card-header text-white" style=" background: linear-gradient(to right, #1e88e5, #66bb6a);">
					<spam><i class="fas fa-plus"></i></spam> <b>Insertar datos del teléfono</b>
				</div>
              <!-- /.card-header -->
              <!-- form start -->
              <form onsubmit="return validar()" action="<?php echo base_url('index.php/controller/insTelefonoM')?>" method="POST" >
				  ...
				  <div class="col-1"></div>
					<div class="form-group col-md-4">
						...
						<select onchange="cambioGrado()" class="form-control" id="propietario" name="propietario"  >      
							<option disabled selected value="0">--Seleccione el propietario--</option>
					...
					<div class="col-1"></div>
					<div class="form-group col-md-4">
				  		<label for="cargo"><label style="color: red;">*&nbsp;</label>Número:</label><input type="text" value="" required  pattern="[0-9]{8}" maxlength="8" oninput="checkNumero(this);" class="form-control" name="numero" id="numero" placeholder="Entre el número">  
