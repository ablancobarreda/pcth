...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><spam><i class="fas fa-edit"></i></spam> Editar innovación:</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Editar innovación</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
				<div class="card-header text-white" style=" background: linear-gradient(to right, #1e88e5, #66bb6a);">
					<spam><i class="fas fa-edit"></i></spam> <b>Editar datos de la innovación</b>
				</div>
              <!-- /.card-header -->
              <!-- form start -->
              <form onsubmit="return validar()" action="<?php echo base_url('index.php/controller/edtInnovacionM')?>" method="POST" >
			  <?php  foreach ($innovacion->result() as $i) {  ?>
			 	 <div class="card-body">
				  
				  <input type="hidden" class="form-control" value="<?php echo $i->idinnovacion ; ?>" name="idinnov" id="idinnov" > 
				  ...
				  <div class="col-1"></div>
					<div class="form-group col-md-4">
						...
						<select onchange="cambioTInnovacion()" class="form-control" id="tipoinnovacion" name="tipoinnovacion"  >      
							<option disabled value="0">--Seleccione el tipo de innovación--</option>
							<option value="Generalización" <?php if($i->tipo == "Generalización") echo 'selected="selected"'?>>Generalización</option>
							<option value="Radical" <?php if($i->tipo == "Radical") echo 'selected="selected"'?> >Radical</option>
							<option value="Rupturista" <?php if($i->tipo == "Rupturista") echo 'selected="selected"'?>>Rupturista</option>
							<option value="Transferencia tecnológica" <?php if($i->tipo == "Transferencia tecnológica") echo 'selected="selected"'?>>Transferencia tecnológica</option>
						</select>  
					...
					<div class="col-1"></div>
					<div class="form-group col-md-4">
				  		<label for="cargo"><label style="color: red;">*&nbsp;</label>Denominación:</label><input type="text" value="<?php echo $i->denominacion; ?>" required  pattern="[a-zA-Z\sñÑáéíóúÁÉÍÚÓ]+"  oninput="checkDenominacion(this);" class="form-control" name="denominacion" id="denominacion" placeholder="Entre la denominación">  
					...
					<div class="form-group col-md-4">
						...
						<option disabled  value="0">--Seleccione la clasificación--</option>
							<option value="Abierta" <?php if($i->clasificacion == "Abierta") echo 'selected="selected"'?>>Abierta</option>
							<option value="Secreta" <?php if($i->clasificacion == "Secreta") echo 'selected="selected"'?>>Secreta</option>
						</select>  
					...
					<div class="col-1"></div>
					<div class="form-group col-md-4">
				  		<label for="cargo"><label style="color: red;">*&nbsp;</label>Solución no identificada:</label><input type="text" value="<?php echo $i->solucionNoIdent; ?>" required  pattern="[a-zA-Z\sñÑáéíóúÁÉÍÚÓ]+"  oninput="checkSolNoIdent(this);" class="form-control" name="solNoIdent" id="solNoIdent" placeholder="Entre el la solución no identificada">  
