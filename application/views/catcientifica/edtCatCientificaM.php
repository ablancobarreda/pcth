...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><spam><i class="fas fa-edit"></i></spam> Editar categoría científica:</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Editar categoría científica</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
				<div class="card-header text-white" style=" background: linear-gradient(to right, #1e88e5, #66bb6a);">
					<spam><i class="fas fa-edit"></i></spam> <b>Editar datos de la categoría científica</b>
				</div>
              <!-- /.card-header -->
              <!-- form start -->
              <form onsubmit="return validar()" action="<?php echo base_url('index.php/controller/edtCatCientificaM')?>" method="POST" >
			  <?php  foreach ($catcient->result() as $t) {  ?>
			 	 <div class="card-body">
				  
				  <input type="hidden" class="form-control" value="<?php echo $t->idcategoriaCientifica ; ?>" name="idt" id="idt" > 
				  ...
				  <div class="row">
					...
					<div class="form-group col-md-4">
						...
						<select onchange="cambioTAutor()" class="form-control" id="tipoautor" name="tipoautor"  >      
							...
							<option value="Aspirante" <?php if($t->tipo == "Aspirante") echo 'selected="selected"'?>>Aspirante</option>
							<option value="Agregado" <?php if($t->tipo == "Auxiliar") echo 'selected="selected"'?>>Agregado</option>
							<option value="Auxiliar" <?php if($t->tipo == "Auxiliar") echo 'selected="selected"'?>>Auxiliar</option>
							<option value="Titular" <?php if($t->tipo == "Titular") echo 'selected="selected"'?>>Titular</option>
						</select>  
					...
					<div class="col-1"></div>
					<div class="form-group col-md-4">
				  		<label for="fechaDefensa"><label style="color: red;">*&nbsp;</label>Fecha:</label><input type="date" value="<?php echo $t->fecha ; ?>" required  class="form-control" name="fecha" id="fecha" >  
