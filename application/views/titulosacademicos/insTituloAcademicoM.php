...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><spam><i class="fas fa-plus"></i></spam> Insertar título académico:</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Insertar título académico</li>
                    </ol>
                </div>
                <!-- /.col -->
            </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-primary">
				<div class="card-header text-white" style=" background: linear-gradient(to right, #1e88e5, #66bb6a);">
					<spam><i class="fas fa-plus"></i></spam> <b>Insertar datos del título académico</b>
				</div>
              <!-- /.card-header -->
              <!-- form start -->
              <form onsubmit="return validar()" action="<?php echo base_url('index.php/controller/insTituloAcademicoM')?>" method="POST" >
				  ...
				  <div class="col-1"></div>
					...
					<div class="col-1 "></div>
					  ...
					  <div class="col-1"></div>
					  <div class="form-group col-md-4">
							<label for="problematica"><label style="color: red;">*&nbsp;</label>Centro de referencia:</label><input type="text" value=""  required  pattern="[a-zA-Z\sñÑáéíóúÁÉÍÚÓ]+"  oninput="checkCReferencia(this);" class="form-control" name="cestudio" id="cestudio" placeholder="Entre el centro de referencia">  
					  ...
					  <div class="col-1"></div>
					  <div class="form-group col-md-4">
							<label for="problematica"><label style="color: red;">*&nbsp;</label>Centro de estudio:</label><input type="text" value=""  required  pattern="[a-zA-Z\sñÑáéíóúÁÉÍÚÓ]+"  oninput="checkEstudio(this);" class="form-control" name="estudio" id="estudio" placeholder="Entre el centro de estudio">  
					  ...
					  <div class="col-1"></div>
					  <div class="form-group col-md-4">
							<label for="problematica"><label style="color: red;">*&nbsp;</label>Carrera:</label><input type="text" value=""  required  pattern="[a-zA-Z\sñÑáéíóúÁÉÍÚÓ]+"  oninput="checkCarrera(this);" class="form-control" name="carrera" id="carrera" placeholder="Entre la carrera">  
					...
					<div class="col-1"></div>  
						...
						<div class="col-1"></div>
						<div class="form-group col-md-4">
								<label for="problematica"><label style="color: red;">*&nbsp;</label>Cantidad horas:</label><input type="text" value=""  required  pattern="[0-9]+"  oninput="checkcantH(this);" class="form-control" name="canth" id="canth" placeholder="Entre la cantidad de horas">  
						...
						<div class="col-1"></div>
						<div class="form-group col-md-4">
								<label for="problematica"><label style="color: red;">*&nbsp;</label>Libro:</label><input type="text" value=""  required  pattern="[a-zA-Z\sñÑáéíóúÁÉÍÚÓ]+"  oninput="checkLibro(this);" class="form-control" name="libro" id="libro" placeholder="Entre el libro">  
					  ...
					  <div class="col-1"></div>
					  <div class="form-group col-md-4">
							  <label for="cargo"><label style="color: red;">*&nbsp;</label>Tomo:</label><input type="text" value="" required  pattern="[0-9]+"  oninput="checkTomo(this);" class="form-control" name="tomo" id="tomo" placeholder="Entre el tomo">  
					  ...
					  <div class="col-1"></div>
					  <div class="form-group col-md-4">
							  <label for="cargo"><label style="color: red;">*&nbsp;</label>Folio:</label><input type="text" value="" required  pattern="[0-9]+"  oninput="checkFolio(this);" class="form-control" name="folio" id="folio" placeholder="Entre el folio">  
					  ...
					  <div class="col-1"></div>
					  <div class="form-group col-md-4">
							  <label for="cargo"><label style="color: red;">*&nbsp;</label>Calificación:</label><input type="text" value="" required  pattern="[0-9]+"  oninput="checkCalificacion(this);" class="form-control" name="calificacion" id="calificacion" placeholder="Entre la Calificación">  
